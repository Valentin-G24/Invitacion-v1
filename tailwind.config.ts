  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'petal-fall': {
          '0%': { transform: 'translateY(-10%) rotate(0deg) translateX(0)', opacity: '0.8' },
          ...
          '75%': { transform: 'translateY(75vh) rotate(270deg) translateX(15px)', opacity: '0.3' },
